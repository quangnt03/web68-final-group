...
const LoginRegister = () => {
  ...
  useEffect(() => {
    if (
      valueLogin.userName !== dataRegister.username ||
      valueLogin.password !== dataRegister.password
    ) {
  ...
  return (
    <div className="body-form">
      <div className="title-login-resigter">
        <a onClick={onClickCardLogin} className={styleCardLogin}>
          Đăng nhập
        </a>
        <a onClick={onClickCardRegister} className={styleCardRegister}>
          Tạo tài khoản
        </a>
      </div>
      <div className="form-container">
        ...
        <form
          onSubmit={handleSubmit(onFormSubmitRegisterHandle)}
          className={styleFormRegister}
        >
          <div className="mb-3">
            <label htmlFor="username" className="form-label">
              Họ và tên
            ...
            <input
              ...
              {...register("password", {
                ...
                pattern: {
                  value: /^(?=.*[!@#$%^&*()_+[\]{};':"\\|,.<>/?])\S+$/,
                  message:
                    "Mật khẩu có ít nhất 8 kí tự bao gồm có một kí tự đặc biệt",
                },
                minLength: {
                  value: 8,
